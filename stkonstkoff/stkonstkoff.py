...
def main():
    ...
    if cf.num_stacks:
        ...
        Utilities.print_numbered_list(cf.stacks)
        question = "Would you like to delete all of these stacks?"
        if Utilities.yes_or_no(question):
            cf.delete_selections(cf.stacks)
    else:
        question = "Create saved templates?"
        if Utilities.yes_or_no(question):
            cf.create_all_stacks()
